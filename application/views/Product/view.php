			...
			<div class="single-main">
                ...
                <?php endif;?>
					...
					<div class="col-md-7 single-top-right">
						...
						<h2><?=$product->title;?></h2>
							...
							<h5 class="item_price" id="base-price" data-base="<?=$product->price * $curr['value'];?>"><?=$curr['symbol_left'];?><?=$product->price * $curr['value'];?><?=$curr['symbol_right'];?> <?php if($product->old_price): ?>
                ...
                <div class="latestproducts">
					<div class="product-one">
                        <h3>With this Watch also bying:</h3>
                        <?php foreach($related as $item): ?>
							...
							<?php endif;?></span></h4>
                                    ...
                                    <?php if($item['old_price']): ?>
                                        <div class="srch">
                                            <span><?=number_format(((1 - ($item['price']/$item['old_price']))*100), 1);?>%</span>
                                        </div>
                                    <?php endif;?>
                                </div>
						    </div>
